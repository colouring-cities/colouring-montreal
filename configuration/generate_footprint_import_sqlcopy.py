...
OUTPUT_FILENAME = "buildings_with_correct_archetype_key.sql"
...
OUTPUT.append("""CREATE TABLE IF NOT EXISTS new_geometries (
    ...
    geometry_geom geometry(int2, 3857)
);\n""")
    ...
    with open(geojson_file, 'r', encoding="utf8") as content_file:
        ...
        for entry in data["features"]:
            ...
            if len(object_id) > 30:
               ...
               #  values.append("('" + str(entry['properties']['STRUCT_ID']) + "', " + str(int(entry['properties']['YR_BUILT'])) + ")")
